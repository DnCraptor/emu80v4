...
// How many times to output the same TMDS buffer before recycling it onto the
// free queue. Pixels are repeated vertically if this is >1.
// Exposed as a variable so bk.c can change it at runtime (e.g. 3 for 800x600, 2 for 1024x768).
