...
Во встроенном ПЗУ рисутствует полноценная ветвь загрузки с FDD:
...
После копирования возврат организован через адрес `0100h`. Для определения
названий и интерфейса этих трёх встроенных программ требуется отдельный анализ
самих скопированных блоков, а не только диспетчера клавиш.
